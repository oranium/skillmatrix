...
|Pfeil-Button |Klappt eine Liste von Skills aus, welche der Mitarbeiter in der zugehörigen Überkategorie besitzt.
|Skill-Anzeige  |Zeigt Skills und deren Spezifikationen sowie Level des SKills.
|Neuen Skill Erstellen-Button|Ermöglicht es einen neuen Skill hinzuzufügen, falls es sich um das eigene Profil handelt.
|===

Die Skill-Überkategorien zeigen auch wie viele verschiedene Fähigkeiten der Mitarbeiter in dieser Kategorie besitzt.

Falls es sich um das eigene Profil handelt ist es möglich das Level einen Skills zu verändern.
////
Für jeden Dialog:
