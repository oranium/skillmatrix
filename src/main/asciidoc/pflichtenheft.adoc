...
|+-Button |Zeigt nähere Angaben zur Fähigkeit des Mitarbeites durch eine Grafik.
|View Profile-Button |Ermöglicht es auf die Profil-Seite eines Mitarbeites zu wechseln.
|===


==== Eigene-Profil-Skill-Seite
Zeigt verschiedene Skills des eigenes Profils.
...
Die Skill-Level und Skill-Unterkategorie-Level lassen sich sich durch Klick bearbeiten. 

==== Add-Milestone-Seite
Ermöglicht das Hinzufügen eines Meilensteins für eine Fähigkeit, also dem Punkt der Entwicklung einer Fähigkeit.
...
|Level-Buttonleiste |Bestimmt das wie gut die neue Fähigkeit beherrscht wird.
...
Zeigt die historische Grafiken der Fähigkeitsentwicklung eines Mitarbeites
...
|Fähigkeits-Anzeige |Zeigt Fähigkeiten mit Entwicklungsgraph und letzten Meilensteinen.
|Vollbild-Button |Ermöglicht eine genauere Ansicht einer Fähigkeit.
|===

==== Profil-Statistik-Graph-Seite
Zeigt die historische Grafiken einer Fähigkeit eines Mitarbeites
